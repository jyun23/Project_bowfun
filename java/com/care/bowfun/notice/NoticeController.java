...
//        	 sessionId = "admin";
     ...
     public String NoticeModifyProc(MultipartHttpServletRequest multi, String no, RedirectAttributes ra) {
         String sessionId = (String) session.getAttribute("id");
         if(sessionId == null)
//        	 sessionId = "admin";
        	 return "redirect:login";
         ...
         String msg = service.NoticeModifyProc(multi, no);
         ra.addFlashAttribute("msg", msg);

         if(msg.equals("게시글 수정 성공"))
             return "redirect:NoticeForm";

         return "redirect:NoticeModify?no="+no;
     }
